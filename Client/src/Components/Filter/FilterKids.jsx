...
function FilterKids({kidColors,kidCompanies,kidCategories,kidSizes,sizeFilter,ColorFilter,CategoryFilter,priceFilter,CompanyFilter,emptyFilter}) {
  return (
    <>
                ...
                <div className="ml-6 mt-4 flex flex-col">
                    ...
                    {
                        (kidCategories).map((kidcategory,index) => (
                ...
                <div className="ml-6 mt-4 flex flex-col">
                    <p className="font-bold text-lg text-slate-700 my-5">SIZE</p>
                    {
                        (kidCompanies).map((kidcompany,index) => (
